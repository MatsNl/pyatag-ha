...
from pyatag import AtagDataStore, SENSOR_TYPES, AtagException, discover_atag
import pyatag.discovery
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    atag = AtagDataStore(session, host=host, port=port, device=device, mail=mail, paired=True)
    try:
    ...
    async def async_close_session(event) -> None:
